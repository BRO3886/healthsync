...
# healthsync installer — downloads the latest release from GitHub
# Usage: curl -fsSL https://healthsync.sidv.dev/install | bash
...
echo ""
info "healthsync can install an AI agent skill that teaches Claude Code / Codex / OpenClaw how to use it."
